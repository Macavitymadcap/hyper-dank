...
describe("WalksRow", () => {
  test("renders row cells and clear behavior", () => {
    ...
    expect(html).toContain('<td class="table-cell walks-cell">1.2</td>');
    expect(html).toContain('<td class="table-cell walks-cell">15.8</td>');
    ...
    expect(html).toContain('action="/walks/1/delete"');
