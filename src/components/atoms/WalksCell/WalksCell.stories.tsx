...
const meta = {
  ...
  tags: ["autodocs"],
  title: "Components/Atoms/WalksCell",
} satisfies Meta<WalksCellStoryArgs>;

export default meta;
type Story = StoryObj<WalksCellStoryArgs>;
