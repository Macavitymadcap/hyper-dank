...
describe("Layout", () => {
  test("renders document chrome and shared CSS", () => {
    ...
    expect(html).toContain("--scrollable-table-current-scroll-body-rows: var(--scrollable-table-scroll-body-rows)");
    ...
    expect(html).toContain(".scrollable-table-container[data-scrollable=\"true\"] .scrollable-table tbody");
    expect(html).toContain("--scrollable-table-current-scroll-body-rows: var(--scrollable-table-mobile-scroll-body-rows)");
