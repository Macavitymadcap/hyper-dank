...
describe("verification helpers", () => {
  ...
  test("builds verification gates with useful defaults", () => {
    expect(
      createVerificationGate({ id: "check", name: "Check", command: "bun", args: ["test"] }),
    ).toEqual({
      id: "check",
      name: "Check",
      tooling: "bun",
    ...
    expect(createCommandGate("lint", "Lint", "bun", ["run", "check"], "Biome")).toEqual({
      id: "lint",
      name: "Lint",
      tooling: "Biome",
      command: "bun",
