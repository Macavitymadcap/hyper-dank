...
| Package import contracts and package-specific examples | `libs/*/README.md` | `site/libraries.md`, `e2e/consumer-compat/app-shapes.test.tsx` | Package READMEs should stay closer to exports than the public site. |
