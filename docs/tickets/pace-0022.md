...
- Keep `@macavitymadcap/hyper-dank-components/styles.css` as the public CSS side-effect import.
...
```mermaid
flowchart LR
  Consumer["Consumer app CSS entry"] --> Import["import @macavitymadcap/hyper-dank-components/styles.css"]
