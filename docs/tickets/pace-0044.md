...
- Replaced the wide public docs link row with a compact `details` navigation menu.
- Adapted the Character Sheet checkbox-backed theme switch pattern for the docs shell.
- Wrapped generated Markdown tables in focusable horizontal scroll containers and added table
  styling that keeps wide API tables inside the viewport.
- Added docs build coverage for the compact navigation, theme switch, and table wrapper contracts.
