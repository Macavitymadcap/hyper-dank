...
| Target PR | [#3](https://github.com/Macavitymadcap/pace-calculator/pull/3) |
...
| `NODE_ENV` | Production | Enables production auth/email behaviour |
...
- Landed on `main` through PR [#3](https://github.com/Macavitymadcap/pace-calculator/pull/3) as the squashed commit `4196b94`.
