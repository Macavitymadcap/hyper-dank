...
- Expanded the floating Storybook theme switch into a compact utility control with quick links for
  docs, library docs, and the Walking Pace demo.
- Kept links relative to the Storybook iframe so they resolve under the deployed Pages base path and
  open in the top-level browsing context.
- Added a Storybook smoke assertion for the utility links and theme switch at a mobile viewport.
