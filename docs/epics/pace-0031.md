...
| `pace-0034` | `pace-0034` | Introduce `@macavitymadcap/hyper-dank-scripts` | A new package exports process, GitHub, verification, local-server, screenshot, and browser-test helpers with package docs and tests |
