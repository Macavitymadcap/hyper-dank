...
- No attempt to make Better Auth, admin, invitations, or server-owned sessions work in the static
  demo.
- No Railway production deployment after this epic lands.
...
| `pace-0027` | `pace-0027` | Replace Railway production deployment with GitHub Pages | Pages workflow builds Jekyll, the pace demo, and Storybook into one artifact and removes active Railway production docs/config |
...
- Railway is no longer the production deployment path after this epic.
