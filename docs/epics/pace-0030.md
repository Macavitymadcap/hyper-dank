...
| `pace-0036` | `pace-0036` | Document platform adoption patterns | Public docs and package READMEs explain component groups, script-library usage, and app-shape recipes for server apps, static demos, blogs, and dashboards without consuming-app handoff content |
